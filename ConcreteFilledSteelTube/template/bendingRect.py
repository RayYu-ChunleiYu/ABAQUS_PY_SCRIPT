...
for fix_perportion in [supprot_location_proportion,(1-supprot_location_proportion)]:
    dp_1_feature = part_tube.DatumPointByCoordinate((section_width/2,0,height*fix_perportion))
    dp_2_feature = part_tube.DatumPointByCoordinate((0,section_height/2,height*fix_perportion))
    dp_3_feature = part_tube.DatumPointByCoordinate((-section_width/2,0,height*fix_perportion))
    
    dp_1 = part_tube.datums[dp_1_feature.id]
    dp_2 = part_tube.datums[dp_2_feature.id]
    dp_3 = part_tube.datums[dp_3_feature.id]
    # partition steel
    cells_to_be_partititon = part_tube.cells.findAt(((0,section_height/2-thickness/2,height*fix_perportion),))
...
for load_perportion in [load_location_proportion,1-load_location_proportion]:
    dp_1_feature = part_tube.DatumPointByCoordinate((section_width/2,0,height*load_perportion))
    dp_2_feature = part_tube.DatumPointByCoordinate((0,section_height/2,height*load_perportion))
    dp_3_feature = part_tube.DatumPointByCoordinate((-section_width/2,0,height*load_perportion))
    
    dp_1 = part_tube.datums[dp_1_feature.id]
    dp_2 = part_tube.datums[dp_2_feature.id]
    dp_3 = part_tube.datums[dp_3_feature.id]
    # partition steel
    cells_to_be_partititon = part_tube.cells.findAt(((0,section_height/2-thickness/2,height*load_perportion),))
    part_tube.PartitionCellByPlaneThreePoints(point1=dp_1,point2=dp_2,point3=dp_3,cells=cells_to_be_partititon)
...
load_edges_11 = tube_edges.findAt(((section_width/4,section_height/2,height*load_location_proportion),))
assembly.Set(edges=load_edges_11, name='load_edges_11')
load_edges_12 = tube_edges.findAt(((-section_width/4,section_height/2,height*load_location_proportion),))
assembly.Set(edges=load_edges_12, name='load_edges_12')
load_edges_21 = tube_edges.findAt(((section_width/4,section_height/2,height*(1-load_location_proportion)),))
assembly.Set(edges=load_edges_21, name='load_edges_21')
load_edges_22 = tube_edges.findAt(((-section_width/4,section_height/2,height*(1-load_location_proportion)),))
assembly.Set(edges=load_edges_22, name='load_edges_22')

# fix location defined
tube_edges = assembly.instances['instance_tube'].edges
fix_edge_11 = tube_edges.findAt(((section_width/4,-section_height/2,height*supprot_location_proportion),))
assembly.Set(edges=fix_edge_11, name='fix_edge_11')
fix_edge_12 = tube_edges.findAt(((-section_width/4,-section_height/2,height*supprot_location_proportion),))
assembly.Set(edges=fix_edge_12, name='fix_edge_12')
fix_edge_21 = tube_edges.findAt(((section_width/4,-section_height/2,height*(1-supprot_location_proportion)),))
assembly.Set(edges=fix_edge_21, name='fix_edge_21')
fix_edge_22 = tube_edges.findAt(((-section_width/4,-section_height/2,height*(1-supprot_location_proportion)),))
assembly.Set(edges=fix_edge_22, name='fix_edge_22')

# plate fix edge 
plate_fix_edge = assembly.instances['instance_plate1'].edges.findAt(((0,-plate_rectangle_size/2,0-plate_thickness),))
assembly.Set(edges=plate_fix_edge, name='plate_fix_edge')
...
for fix_edge in ['fix_edge_11','fix_edge_12']:
    ...
    createStepName='Initial', region=region, u1=UNSET, u2=SET, u3=SET, ur1=UNSET, 
...
for fix_edge in ['fix_edge_21','fix_edge_22']:
    ...
    createStepName='Initial', region=region, u1=UNSET, u2=SET, u3=UNSET, ur1=UNSET, 
    ur2=UNSET, ur3=UNSET, amplitude=UNSET, distributionType=UNIFORM, 
    fieldName='', localCsys=None)

# plate fix add
##### region = assembly.sets['plate_fix_edge']
# mdb.models[model_name].DisplacementBC(name='plate fix edge : ', 
#     createStepName='Initial', region=region, u1=UNSET, u2=UNSET, u3=SET, ur1=UNSET, 
#     ur2=UNSET, ur3=UNSET, amplitude=UNSET, distributionType=UNIFORM, 
#     fieldName='', localCsys=None)
...
# current_model.Tie(name='concrete-tube', main=assembly.instances['instance_concrete'].surfaces['contact_face'], secondary=assembly.surfaces['tube_contact'], 
#     positionToleranceMethod=COMPUTED, adjust=ON, tieRotations=ON, thickness=ON)

# current_model.Tie(name='concrete-plate-1', main=assembly.instances['instance_concrete'].surfaces['plate1_contact_faces'], secondary=assembly.surfaces['plate1_tie'], 
#     positionToleranceMethod=COMPUTED, adjust=ON, tieRotations=ON, thickness=ON)

# current_model.Tie(name='concrete-plate-2', main=assembly.instances['instance_concrete'].surfaces['plate2_contact_faces'], secondary=assembly.surfaces['plate2_tie'], 
#     positionToleranceMethod=COMPUTED, adjust=ON, tieRotations=ON, thickness=ON)
