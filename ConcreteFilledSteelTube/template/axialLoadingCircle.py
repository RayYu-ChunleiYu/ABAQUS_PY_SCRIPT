...
# load add 
region = assembly.sets['plate2_load']
...
# fix1 add
region = assembly.sets['plate1_fix']
...
current_model.FieldOutputRequest(name='displacement', 
    createStepName='Step-1', variables=('UT', ), region=assembly.sets['plate2_load'], 
    sectionPoints=DEFAULT, rebar=EXCLUDE)

current_model.FieldOutputRequest(name='force', createStepName='Step-1', 
    variables=('RF', ), region=assembly.sets['plate2_load'], 
    sectionPoints=DEFAULT, rebar=EXCLUDE)
