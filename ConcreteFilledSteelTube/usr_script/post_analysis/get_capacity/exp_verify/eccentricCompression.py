...
specimen_name_series = eccentric_compression_data['No']
operator_series = eccentric_compression_data['Operator']
section_type_series = eccentric_compression_data['Section_type']
section_height_series = eccentric_compression_data['Height(Diameter)']
section_width_series = eccentric_compression_data['Width(Diameter)']
thickness_series = eccentric_compression_data['Tube_thickness']
fy_series = eccentric_compression_data['fy']
fc_series = eccentric_compression_data['fck']
...
expand_index = 1
for e in e_series:
    for specimen_name,section_type,section_height, section_width, thickness, fy, fc in zip(specimen_name_series,section_type_series,
        ...
        parameters = {
            ...
            "task_work_dir": os.path.join(CWD, 'run_files_exp_verify', "eccentricCompression",
                                          f"{specimen_name}"),
