...
class TaskEccentricLoading(Task):
    ...
    def script_refactor_common(self):
        ...
        self.script_FEM_run_string = self.script_FEM_run_string.replace("height = height*3",
                                                                        "height = {}".format(geometry['height']))
        self.script_FEM_run_string = self.script_FEM_run_string.replace("e = 10", "e = {}".format(e))
        ...
        self.script_FEM_get_data_string = self.script_FEM_get_data_string.replace(
            ...
            "o1 = session.openOdb(name=r'{}')".format(odb_path)
        )
        self.script_FEM_get_data_string = self.script_FEM_get_data_string.replace(
            "odb = session.odbs[r'E:/YuChunlei/data_expand_FEM/bending_analysis.odb']",
            "odb = session.odbs[r'{}']".format(odb_path)
        )
    ...
    def get_fu_as_excel(self):
        ...
        for dir in dirs:
            ...
            if os.path.isdir(dir_abs):
                ...
                current_data.insert(0, 'e', parameters['e'])
                ...
                find_steel_array = (max_steel_strain - 0.01) ** 2
